package com.register.move.service.plugin.eureka.event;
...
public class EurekaEvent extends BaseEvent {
    ...
    public  List<InstanceInfo>  transformObjects(){
        ...
        //    InstanceInfo instanceInfo = EurekaInstanceConverter.createInstance(m.getServiceName(), m.getIp(), m.getPort(), m.getExtendedAttributes());
    ...
    public InstanceInfo buildSyncInstance(StandardServiceMetadata instance, String group) {
        ...
        String serviceName = transformName(instance.getServiceName(),group);
